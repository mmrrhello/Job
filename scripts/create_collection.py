...
创建 Milvus job_chunks 与 chat_memory collection 和索引（MilvusClient）。
...
def _create_collection_if_missing(client: MilvusClient, col_name: str, fields: list[FieldSchema], description: str):
    ...
    client.create_index(collection_name=col_name, field_name="vector", index_params=index_params)
